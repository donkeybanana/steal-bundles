...
define('package.json!npm', [
    ...
    if (!loader.main) {
        loader.main = 'steal-bundles@0.0.1#index';
    }
    ...
    (function (loader, packages, options) {
    ...
    }(loader, [
        {
            ...
            'steal': {
                ...
                'envs': {
                    'build-development': { 'map': { 'jquery': '@empty' } },
                    'window-production': { 'paths': { 'jquery': 'https://code.jquery.com/jquery-3.4.1.min.js' } }
                },
                'npmAlgorithm': 'flat'
            },
            'resolutions': {
...
/*steal-bundles@0.0.1#jquery/plugin*/
define('steal-bundles@0.0.1#jquery/plugin', [
    'exports',
    'jquery'
    ...
    var plugin = function plugin(name, _constructor) {
        _jquery2.default.fn[name] = function (opts) {
...
/*steal-bundles@0.0.1#lib/controller*/
define('steal-bundles@0.0.1#lib/controller', [
    'exports',
    'jquery'
], function (exports, _jquery) {
    'use strict';
    ...
    var Controller = function Controller(el) {
        _classCallCheck(this, Controller);
        this.element = (0, _jquery2.default)(el);
    };
    exports.default = Controller;
});
/*steal-bundles@0.0.1#app/app*/
define('steal-bundles@0.0.1#app/app', [
    'exports',
    '../jquery/plugin.js',
    '../lib/controller.js'
], function (exports, _plugin, _controller) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
    ...
    var App = function (_Controller) {
        _inherits(App, _Controller);
        function App(el, opts) {
            ...
            _this.element.html(_this.render());
            return _this;
        }
        _createClass(App, [{
                key: 'render',
    ...
    (0, _plugin2.default)('app', App);
    exports.default = App;
});
/*steal-bundles@0.0.1#private*/
define('steal-bundles@0.0.1#private', [
    'exports',
    './app/app.js'
], function (exports, _app) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
    ...
    $('#root').app({ message: 'Hello, bundles!' });
